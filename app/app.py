    ...
    if tf and os.path.exists("deepfake/deepfake_cnn.h5"):
        try:
            try:
                ...
                pass
            df_model = tf.keras.models.load_model(
                "deepfake/deepfake_cnn.h5", compile=False
            )
        except Exception:
            df_model = None
...
def show_detector_page():
    ...
    with right:
        ...
        status_rows.append(
            (
                "Decision Engine",
                "READY" if (genai and GEMINI_API_KEY) else "UNAVAILABLE",
            )
        )
    ...
    if run_btn:
        ...
        with res_col1:
            ...
            if verdict == "SUPPORTED":
                st.markdown(
                    f'<div class="css-card" style="border-left: 5px solid #38ef7d;">'
                ...
                st.markdown(
                    f'<div class="css-card" style="border-left: 5px solid #ef473a;">'
                ...
                st.markdown(
                    f'<div class="css-card" style="border-left: 5px solid #ffb000;">'
        ...
        if evid_sorted:
            ...
            for i, e in enumerate(evid_sorted[:6]):
                ...
                with col:
                    ...
                    # Clean snippet
                    snip = (
                        (e.snippet[:150] + "...") if len(e.snippet) > 150 else e.snippet
                    )
